                ...
                <div class='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div class='flex justify-between h-16'>
                        <div class='flex'>
                            ...
                            <div class='shrink-0 flex items-center'>
                                <h2 class='font-semibold text-xl text-gray-800 leading-tight'>
                                    <a href='{{ route('dashboard') }}'> {{ __('labels.TaskManager') }} </a>
                                </h2>
                            </div>
                        ...
                        <div class='hidden sm:flex sm:items-center sm:ml-6'>
                            ...
                            @guest
                            <div>
                                <a class='btn btn-outline-success' href='{{ route('login') }}'> {{ __('labels.LogIn') }} </a>
                                <a class='btn btn-outline-success' href='{{ route('register') }}'> {{ __('labels.SignUp') }} </a>
                            </div>
                            @endguest
                        </div>
                    </div>
